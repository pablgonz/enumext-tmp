...
\begin{enumext}[columns=1,save-ans=sabastiano2,mark-pos=left,mark-ans=$\checkmark$,save-ref=true,show-pos=true,itemsep=0pt]
 \item La velocità di \SI{1,00e2}{m/s} espressa in \si{km/h} è:
   \begin{keyans*}[mini-env=0.5\linewidth, mini-right* = { \includegraphics[scale=0.15]{example-image-b} \captionof*{figure}{A table} }]
     \item \SI{36}{km/h}.
     \item* \SI{360}{km/h}.
     \item \SI{27,8}{km/h}.
     \item \SI{3,60e8}{km/h}.
 ...
 ($\SI{1}{fm} = \SI{1e-15}{m}$). Qual è la relazione tra queste due
 unità di misura?
   \begin{keyans*}[columns=2,mini-env=0.25\linewidth, mini-right*={\includegraphics[scale=0.15]{example-image-b}}]
