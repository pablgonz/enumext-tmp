...
%<*example>
% \fi
\begin{filecontents*}[overwrite]{enumext-05.tex}
...
\foreachkeyans[wrapper={\makebox[3cm][l]{#1}}]{mytest}
\end{document}
\end{filecontents*}
\IfFileExists{enumext-05.pdf}{}{\ShellEscape{arara enumext-05.tex}}
% \iffalse
%</example>
% \fi
