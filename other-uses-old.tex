...
\item \begin{enumext}[topsep=0pt]
    \item A
    \item C \begin{enumerate} \item Soy un texto quote \item Soy un texto quote \item Soy un texto quote \end{enumerate}
    \item D \begin{verbatim} ZZ,,,sss \end{verbatim}
 \end{enumext}
 %\begin{enumerate} \item Soy un texto quote \item Soy un texto quote \item Soy un texto quote \end{enumerate}
\end{enumext*}
...
\begin{enumerate}
  ...
  \item This text is in the first level. \begin{enumerate} \item item here. \end{enumerate}
...
Hola
\begin{enumext*}[columns=2,widest={20}, itemsep=2cm,parsep=1cm]
...
\item
 galgo corredor.
  ...
  %\anskey(2)*[store-brk]{PPPP}
\end{enumext*}

\noindent Chao

\begin{enumext}[columns=2,widest={20},itemsep=0.4cm,parsep=0.1cm,save-ans=lll]
 \item Hanza en astillero,% \par QUe no quiere nada más en este mundo o el otro.  \anskey(2)*[store-brk]{PPPP}
...
\begin{enumext*}[above=-10pt,nosep,columns=2]
  \item Entry action
