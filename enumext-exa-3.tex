...
\pagestyle{empty}
\begin{document}
\setenumext[keyans]{itemindent=1cm,label=\Alph*,font=\small,nosep,wrap-label={\myCircled{##1}}}
\begin{enumext}[save-ans=simplemc,columns=1,nosep,save-ref,save-sep={; },show-ans,wrap-opt={#1}]
...
Test keys \getkeyans{simplemc:4}
