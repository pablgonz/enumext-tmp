...
\setenumext[enumext,1]{list-offset=1cm,,columns=1,nosep,save-ref=true}
\begin{enumext}[save-ans=simplemc]
...
\foreachkayans[start=2,stop=4,wrapper={\fbox{#1}},sep={\par}]{simplemc}
\end{document}
