...
\begin{document}
 ...
 \begin{enumext}[mode-box,label={},labelsep=4pt,font=\bfseries,labelwidth=5cm,,noitemsep,topsep=3pt, wrap-label* = \itembox{#1}]%  align=right,
  \item[ZZ] This is an entry \textit{without} a label.
  \item[Something \par NOW] A short one-line description.
  \item[Something] A much longer description. orem ipsum dolor sit amet, consectetuer adipiscing elit.
