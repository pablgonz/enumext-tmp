...
\begin{enumext}[columns=2,nosep,label={(\arabic*.)},ref=[\roman*]]%[topsep=0pt,parsep=0pt,partopsep=0pt,itemsep=0pt,columns=1]%,,itemsep=0pt

   \item\label{1} ZZZ Blah % note use of optional argument of \label
...
After enumext [nosep] in vertical mode \ref{1}. %%See \cref{2,3}. \Cref{1} instead, perhaps.
